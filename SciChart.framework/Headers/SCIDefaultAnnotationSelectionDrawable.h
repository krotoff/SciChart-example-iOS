...
//
// SCIDefaultAnnotationSelectionDrawable.h is part of SCICHART®, High Performance Scientific Charts
...
- (nonnull instancetype)initWithColor:(unsigned int)color opacity:(float)opacity andStrokeWidth:(float)strokeWidth;
